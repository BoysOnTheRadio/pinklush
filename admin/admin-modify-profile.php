    ...
    <div class="dashboard-container">
        ...
        <main class="dashboard-main">
            <nav class="sidebar">
                ...
                <a href = "admin-modify-profile.php" class="nav-button active">Modify Profile</a>
